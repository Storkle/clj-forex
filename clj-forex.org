...
#+begin_src clojure :tangle src/forex/module/ea.clj
  ...
  (defmethod copy-ea-obj clojure.lang.Atom [o] (atom @o))
  (defmethod copy-ea-obj clojure.lang.Ref [o] (ref @o))
  (defmethod copy-ea-obj forex.util.core.AtomHash [o] (atom-hash @o))
...
#+begin_src clojure :tangle src/forex/examples/renko/renko.clj
  ...
  ;;TODO: take profit via price action; if GBPJPY is owning, why not trail on 1 minute level?
  (defn five-min-close?
